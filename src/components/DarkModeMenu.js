...
const DarkModeMenu = () => {
  ...
  return (
    <ul id="dropdownDarkMode" className="hidden absolute z-50 top-full right-0 bg-white rounded-lg ring-1 ring-slate-900/10 shadow-lg overflow-hidden w-36 py-1 text-sm text-slate-700 font-semibold dark:bg-slate-800 dark:ring-0 dark:highlight-white/5 dark:text-slate-300 mt-8">
      ...
      <li className="py-1 px-2 flex items-center cursor-pointer  hover:bg-slate-200 dark:hover:bg-slate-700" onClick={(ev) => handleChangeDarkMode(ev, 'dark')}>
      ...
      <li className="py-1 px-2 flex items-center cursor-pointer text-sky-500  hover:bg-slate-200 dark:hover:bg-slate-700">
        <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6 mr-2">
