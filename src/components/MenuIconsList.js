const MenuIconsList = () => (
  <div className="flex items-center border-l border-slate-200 ml-6 pl-6 dark:border-slate-800">
    <label className="sr-only" id="headlessui-listbox-label-:Rpkcr6:" data-headlessui-state="open">
      Theme
    </label>
    <button type="button" id="headlessui-listbox-button-:R19kcr6:" aria-haspopup="true" aria-expanded="true" data-headlessui-state="open" aria-labelledby="headlessui-listbox-label-:Rpkcr6: headlessui-listbox-button-:R19kcr6:" aria-controls="headlessui-listbox-options-:R1pkcr6:">
    ...
    <button type="button" className="ml-2 text-primary-800 hover:text-primary-400 focus:ring-2" aria-label="user button">
      <img src="https://ui-avatars.com/api/?name=Carlos+Garcia&background=7A6F8A&color=fff" alt="User" className="h-6 w-6 rounded-full" />
    </button>
    <ul className="absolute z-50 top-full right-0 bg-white rounded-lg ring-1 ring-slate-900/10 shadow-lg overflow-hidden w-36 py-1 text-sm text-slate-700 font-semibold dark:bg-slate-800 dark:ring-0 dark:highlight-white/5 dark:text-slate-300 mt-8" aria-labelledby="headlessui-listbox-label-:Rpkcr6:" aria-orientation="vertical" id="headlessui-listbox-options-:R1pkcr6:" role="listbox" tabIndex="0" data-headlessui-state="open">
      <li className="py-1 px-2 flex items-center cursor-pointer" id="headlessui-listbox-option-:r0:" role="option" tabIndex="-1" aria-selected="false" data-headlessui-state="">
      ...
      <li className="py-1 px-2 flex items-center cursor-pointer" id="headlessui-listbox-option-:r1:" role="option" tabIndex="-1" aria-selected="false" data-headlessui-state="">
      ...
      <li className="py-1 px-2 flex items-center cursor-pointer text-sky-500" id="headlessui-listbox-option-:r2:" role="option" tabIndex="-1" aria-selected="true" data-headlessui-state="selected">
        <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6 mr-2">
