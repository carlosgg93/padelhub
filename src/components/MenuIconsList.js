  ...
  return (
    <div className="flex items-center border-l border-slate-200 ml-6 pl-6 dark:border-slate-800">
      <button
        ...
        aria-label="ee"
        onClick={() => {
          document.querySelector('#dropdownUserMenu').classList.add('hidden');
      ...
      {isAuthenticated && (
        <>
          <button
            ...
            onClick={() => {
              document.querySelector('#dropdownDarkMode').classList.add('hidden');
              document.querySelector('#dropdownUserMenu').classList.toggle('hidden');
            }}
          >
