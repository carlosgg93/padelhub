  ...
  <div className="w-full max-w-xs mx-auto">
    <form id="loginForm" className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      ...
      <div className="mb-4">
        ...
        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:ring-1 focus:shadow-outline invalid:focus:ring-red-400 peer" id="email" type="email" placeholder="Email" />
