const MenuButton = ({ handleClick }) => (
  ...
  <div className="ml-2 -my-1 md:hidden">
    <button type="button" className="text-primary-800 w-8 h-8 flex items-center justify-center hover:text-primary-400 dark:text-slate-400 dark:hover:text-slate-300" onClick={handleClick}>
